...
| Class Name | CC | Complexity Level |
|------------|----|-----------|
| `CompleteTodoCommandHandler` | 1 | Low |
| `CreateTodoCommandHandler` | 1 | Low |
| `RemoveTodoCommandHandler` | 1 | Low |
| `UpdateTodoCommandHandler` | 1 | Low |
| `FetchTodosByFilterQueryHandler` | 1 | Low |
| `FetchTodosByFilterQuery` | 1 | Low |
| `GetTodoByIdQueryHandler` | 1 | Low |
...
| Metric | Value |
|--------|-------|
| Total Classes/Interfaces/Structs | 30 |
| Total Cyclomatic Complexity | 50 |
| Average CC per Type | 1.67 |
